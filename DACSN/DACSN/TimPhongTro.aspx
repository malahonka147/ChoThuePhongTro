...
<asp:Content ID="Content1" runat="server" contentplaceholderid="ContentPlaceHolder1">
    ...
    <section>
        ...
        <div class="content">
                    ...
                    <div id="right">
                        <h3 class="TieuDe"><a href="Chitiesanpham.html">Chung cư Hoàng Anh Gia Lai An Tiến</a></h3>
                ...
                <div class="content">
                    ...
                    <div id="right">
                        <h3 class="TieuDe"><a href="Chitiesanpham.html">Phòng đẹp, sạch, CC Hoàng Anh Giai Việt có hồ bơi</a></h3>
                ...
                <div class="content">
                    ...
                    <div id="right">
                        <h3 class="TieuDe"><a href="Chitiesanpham.html">Phòng trọ mới xây, giá sinh viên: 3 triệu</a></h3>
                ...
                <div class="content">
                    ...
                    <div id="right">
                        <h3 class="TieuDe"><a href="Chitiesanpham.html">Căn hộ Mini có gác</a></h3>
					    <p class="contentp">Đơn giá:<span class="contentp2">4.5 Triệu/Thắng</span></p>
                        <p class="contentp">Diện tích: <span class="contentp2">25 mét vuông</span></p>
                ...
                <div class="content">
                    ...
                    <div id="right">
                        <h3 class="TieuDe"><a href="Chitiesanpham.html">Cho thuê phòng trọ sạch sẽ, an ninh, yên tĩnh.</a></h3>
                ...
                <div class="content">
                    ...
                    <div id="right">
                        <h3 class="TieuDe"><a href="Chitiesanpham.html">Phòng full nội thất: giá từ:2tr_4tr.</a></h3>
                ...
                <div class="content">
                    ...
                    <div id="right">
                        <h3 class="TieuDe"><a href="Chitiesanpham.html">Phòng trọ có nội thất. Giờ giấc tự do.</a></h3>
                ...
                <div class="content">
                    ...
                    <div id="right">
                        <h3 class="TieuDe"><a href="Chitiesanpham.html">Phòng cao cấp máy lạnh giá:2.5 - 3triệu</a></h3>
                ...
                <div class="content">
                    ...
                    <div id="right">
                        <h3 class="TieuDe"><a href="Chitiesanpham.html">Be Home Gò Vấp nội thất cơ bản. Gần chợ Hạnh Thông Tây. Bảo vệ 24/24</a></h3>
                ...
                <div class="content">
                    ...
                    <div id="right">
                        <h3 class="TieuDe"><a href="Chitiesanpham.html">Ký túc xá, Cạnh trường Đại học Công Nghiệp tiện nghi. Có máy giặt, tủ lạnh.</a></h3>
